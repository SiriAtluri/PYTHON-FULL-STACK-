...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'siri':'siriatluri2005@gmail.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('siriatluri2005@gmail.com','mltm anpr qwsk usol') #enter mailid and app password make sure you enable less secure app access
        mail.sendmail('siriatluri2005@gmail.com',toaddr,content) #enter your gmail username
        mail.close()
        respond('Email Sent')
